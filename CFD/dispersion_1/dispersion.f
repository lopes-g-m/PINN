...
C                SSM(2,J)=SSM(2,J)+(VX(1,J)*MASS(1,j)*(0.5*(Y1(2,J)-
C     &		        Y1(2,J-1)+Y1(1,J)-Y1(1,J-1))))+(DAB(I,J)*
C     &			MASS(1,J)*(8*(0.5*(Y1(2,J)-Y1(2,J-1)+Y1(1,J)-
C     &                  Y1(1,J-1)))/(3*(0.5*(X1(2,J)-X1(1,J)+X1(2,J-1)-
C     &			X1(1,J-1))))))
...
C		PU(2,J)=PU(2,J)+((0.5*(Y1(2,J)-Y1(2,J-1)+
C     &		Y1(1,J)-Y1(1,J-1)))*(ROO(1,J)*VX(1,J)*VX(1,J)))+
C     &		((0.5*(Y1(2,J)-Y1(2,J-1)+Y1(1,J)-Y1(1,J-1)))*
C     &		((8.*VISC(1,J)*VX(1,J))/(3.*(0.5*(X1(2,J)-X1(1,J)+
C     &		X1(2,J-1)-X1(1,J-1))))))
...
c
	...
	if (it<=10000 .and. mod(it,250)==0) then
...
C	X-MOMENTUM (x=1) AND PRESSURE CORRECTION (x=3) EQUATIONS
...
c
	...
	CALL COEFF_TDMA(NeqSTRF,NeqSTRF,STRFrec,AP,
