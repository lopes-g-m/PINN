...
from plot_functions import plot_data_distribution,av_rel_error,relative_error,\
     plot_loss_history, plot_train_history,plot_3_2d_domains,calculate_percentage_in_ranges,\
     plot_3_2d_domains_bump,plot_2d_domains,plot_2d_domains_bump,plot_percentage_histogram,\
     sinal_relative_error,percentage_between
   
###############################################################################

dataFilePath = current_directory + "/dataset/"
savePath = current_directory + "/results/" 
dataFileName = 'dispersion_1' 
Re = 0.933
Pe =  1.056
...
re_u , re_v , re_p ,re_c = relative_error(test_u, pred_u) , relative_error(test_v, pred_v) , relative_error(test_p, pred_p) , relative_error(test_c, pred_c)
