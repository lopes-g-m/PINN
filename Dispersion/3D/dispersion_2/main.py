...
from pre_process import import_multiple_flacs_steady_simulations,pre_process_data,organizeSimulationData,\
     ...
     get_simulation_data,import_flacs_steady_simulation,import_cgns_flacs,process_simulation_data
...
if __name__ == "__main__":       
    ...
    # Import dataset 
    # Dispersion 2   
    path2 = current_directory +  "/dataset/010100.output/"
    file2 = "010100.3d#0000002214"    
    SimulationDataCGNS_2 = import_cgns_flacs(path2, file2)    
    path2 = current_directory + "/dataset/"
    file2 = "010100"    
    flowSolution = "FlowSolutionCC#0000002214"
    SimulationDataCGNS_2_grid = import_cgns_flacs(path2, file2)       
    load_x, load_y, load_z, load_c = process_simulation_data(SimulationDataCGNS_2_grid, SimulationDataCGNS_2,flowSolution)
    data_x,data_y,data_z,data_c = load_x, load_y, load_z, load_c     
    ###############################################################################       
